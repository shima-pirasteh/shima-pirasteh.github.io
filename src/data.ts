...
export const IMAGES = {
  heroBg: "/src/assets/images/hero_bg_1780775122974.png",
  heritageThumb: "/src/assets/images/project_heritage_1780775138482.png",
  experienceThumb: "/src/assets/images/project_experience_1780775154370.png",
  architectureThumb: "/src/assets/images/project_architecture_1780775170785.png",
  shimaHomeBg: "/src/assets/images/shima_heritage_bg_1780776847982.56.48.jpeg",
};
...
export const PROJECTS: Project[] = [
  {
    ...
    thumbnail: "/src/assets/images/WhatsApp Image 2026-06-07 at 23.19.21.jpeg",
    summary: "A contemporary villa in Gilan that blends the privacy-centric introverted courtyard style of central Iran with the elevated, humid-climate design elements of northern Iranian vernacular architecture.",
    role: "Lead Architectural Designer",
    timeline: "2020 - 2021",
    location: "Kiashahr, Gilan, Iran",
    tools: ["Rhino","AutoCAD","Revit"],
    tags: ["Residential Architecture","Bioclimatic Design","Iranian Vernacular","Passive Cooling","Courtyard Villa"],
    caseStudy: {
      challenge: {
        title: "The Spatial Challenge",
        subtitle: "Analyzing programmatic requirements and contextual constraints.",
        content: ["Designing a modern residence in the temperate, highly humid northern region of Gilan requires managing high moisture levels and heavy rainfall while fulfilling the client's desire for privacy. Traditional central Iranian courtyard homes successfully provide privacy but fail to facilitate the essential cross-ventilation needed in humid climates. Conversely, local northern Gilani dwellings are highly open and elevated to maximize airflow, which can often conflict with modern urban requirements for enclosed, private family zones."],
        image: "/src/assets/images/WhatsApp Image 2026-06-07 at 23.19.21.jpeg",
  ...
  },
  {
    ...
    category: "Architecture",
    thumbnail: "/src/assets/images/WhatsApp Image 2026-06-07 at 23.19.21 (12).jpeg",
    summary: "An innovative coastal museum concept inspired by the tension of a red fishing rope and the organic forms of sea foam bubbles along the shoreline.",
    role: "Lead Architectural Designer",
    timeline: "2011",
  ...
  },
  {
    ...
    category: "Architecture",
    thumbnail: "/src/assets/images/WhatsApp Image 2026-06-07 at 23.19.21 (3).jpeg",
    summary: "A modern interior redesign of a medical clinic in Tehran, utilizing warm timber elements, ambient lighting, and optimized zoning to improve patient flow and comfort.",
  ...
  },
  {
    ...
    thumbnail: "/src/assets/images/WhatsApp Image 2026-06-07 at 23.19.21 (5).jpeg",
    summary: "A sophisticated digital modeling and rendering exercise focused on hyper-realistic furniture visualization and fabric simulation.",
  ...
  },
  {
    ...
    category: "Architecture",
    thumbnail: "/src/assets/images/WhatsApp Image 2026-06-07 at 23.19.21 (6).jpeg",
    summary: "An exploration of computational geometry and additive manufacturing to create a self-supporting parametric vase.",
    ...
    caseStudy: {
      ...
      impactOutcome: {
        title: "Ecological & Cultural Impact",
        subtitle: "Reviewing spatial performance and user metrics.",
        content: ["The project demonstrated the viability of using computational design to eliminate material waste and secondary post-processing. The prototype successfully functions as a durable, aesthetic piece of interior decor, showcasing how architectural parametric principles can be scaled down to consumer-level product design."]
      }
    }
  },
  {
    ...
    category: "Architecture",
    thumbnail: "/src/assets/images/WhatsApp Image 2026-06-07 at 23.19.21 (11).jpeg",
    summary: "An innovative high-rise concept that utilizes a folding shell structure mimicking biological growth and healing to optimize daylight, views, and environmental performance.",
    role: "Lead Architectural Designer",
    timeline: "2012",
    location: "Babolsar, Mazandaran, Iran",
    tools: ["Rhino","AutoCAD","Revit"],
  ...
  },
  {
    ...
    category: "Architecture",
    thumbnail: "/src/assets/images/WhatsApp Image 2026-06-07 at 23.19.21 (1).jpeg",
    summary: "A contemporary residential facade in Tehran that translates traditional Persian geometric motifs, specifically the 'Chalipa' cross, into a highly functional, three-dimensional modular building envelope.",
    role: "Lead Architectural Designer",
    timeline: "2021",
    location: "Tehran, Iran",
    tools: ["Rhino","AutoCAD","Revit"],
    ...
    caseStudy: {
      challenge: {
        title: "The Spatial Challenge",
        subtitle: "Analyzing programmatic requirements and contextual constraints.",
        content: ["Modern urban developments in Tehran frequently suffer from a disconnect with Iran's rich architectural heritage, resulting in monotonous facades that fail to address local climatic conditions. The challenge was to design a modern residential facade that honors historical Persian identity while providing modern solutions for solar shading, privacy, and dynamic visual interest on a high-density streetscape."],
        image: "/src/assets/images/WhatsApp Image 2026-06-07 at 23.19.21 (1).jpeg",
        imageCaption: "Ajodanieh Complex contextual visualization."
      },
      researchAnalysis: {
        title: "Research & Mapping Process",
        subtitle: "Establishing structural, environmental, and physical methodologies.",
        content: ["The design process began with an investigation into traditional Persian geometries and historic monuments, including Cyrus's Tomb, the rock-cut Achaemenid tombs, Sassanid relief bedding, and intricate Islamic geometric decorations. The team analyzed the 'Chalipa' (cross) motif, extracting its mathematical ratios and symbolic structure to understand how this historical two-dimensional pattern could be converted into a functional, modular three-dimensional architectural grid."]
      },
      designSolution: {
        title: "Materiality & Structural Expression",
        subtitle: "Synthesizing research vectors into precise architectural form.",
  ...
  },
  {
    ...
    category: "Architecture",
    thumbnail: "/src/assets/images/WhatsApp Image 2026-06-07 at 23.19.21 (2).jpeg",
    summary: "A high-rise residential project in Tehran integrating vertical gardens and modular planning to bring nature back into dense urban living.",
    role: "Lead Architectural Designer",
    timeline: "2020",
    location: "Tehran, Iran",
    tools: ["Rhino","AutoCAD","Revit"],
    ...
    caseStudy: {
      challenge: {
        title: "The Spatial Challenge",
        subtitle: "Analyzing programmatic requirements and contextual constraints.",
        content: ["Rapid urbanization in cities like Tehran has led to a lack of green spaces, degraded air quality, and disconnected vertical living where residents have limited access to natural environments."],
        image: "/src/assets/images/WhatsApp Image 2026-06-07 at 23.19.21 (2).jpeg",
        imageCaption: "Garden Tower contextual visualization."
      },
      researchAnalysis: {
        title: "Research & Mapping Process",
        subtitle: "Establishing structural, environmental, and physical methodologies.",
        content: ["The design process involved researching Tehran's unique local climate, thermal performance requirements, and structural configurations capable of supporting cantilevered soil loads for mature vegetation on high-rise balconies."]
      },
      designSolution: {
        title: "Materiality & Structural Expression",
        subtitle: "Synthesizing research vectors into precise architectural form.",
        content: ["The proposed tower utilizes a modular floor layout featuring alternating, deeply recessed balconies that serve as private elevated gardens. These landscaped terraces act as natural filters for urban dust, improve thermal insulation, and establish a direct connection between the domestic interior and natural micro-climates."]
      },
      impactOutcome: {
        title: "Ecological & Cultural Impact",
        subtitle: "Reviewing spatial performance and user metrics.",
        content: ["The Garden Tower serves as an innovative blueprint for modern urban housing, demonstrating how density and sustainability can coexist to enhance occupant well-being and restore biodiversity in compact metropolitan areas."]
      }
    }
  },
  {
    ...
    category: "Architecture",
    thumbnail: "/src/assets/images/WhatsApp Image 2026-06-07 at 23.19.21 (7).jpeg",
    summary: "A modern villa designed for a semi-cold mountainous environment, featuring a compact footprint and an elevated viewing porch.",
    role: "Lead Architectural Designer",
    timeline: "2020 - 2021",
    location: "Tehran, Iran",
    tools: ["Rhino","AutoCAD","Revit"],
    ...
    caseStudy: {
      challenge: {
        title: "The Spatial Challenge",
        subtitle: "Analyzing programmatic requirements and contextual constraints.",
        content: ["The primary challenge was to design a residential villa in a semi-cold, mountainous region that meets the client's request for a minimal footprint while incorporating an elevated porch at the highest point of the building. This required balancing compact interior spaces with structural stability on sloping terrain, while ensuring proper insulation against harsh environmental winds."],
        image: "/src/assets/images/WhatsApp Image 2026-06-07 at 23.19.21 (7).jpeg",
        imageCaption: "LARGAN VILLA contextual visualization."
      },
      researchAnalysis: {
        title: "Research & Mapping Process",
        subtitle: "Establishing structural, environmental, and physical methodologies.",
        content: ["Environmental research focused on wind patterns and solar orientation to optimize passive heating and natural ventilation. The team analyzed structural load requirements for snow and wind, while topological mapping helped determine the optimal placement of the villa to capture scenic views without compromising thermal efficiency."]
      },
      designSolution: {
        title: "Materiality & Structural Expression",
        subtitle: "Synthesizing research vectors into precise architectural form.",
        content: ["The design features a sharp, asymmetrical roofline that deflects cold winds and prevents snow accumulation, integrating a high-level terrace porch directly into the gable structure. By utilizing a multi-level layout, the internal footprint remains compact, while large floor-to-ceiling glazing on the main level maximizes natural light and passive solar gain."]
      },
      impactOutcome: {
        title: "Ecological & Cultural Impact",
        subtitle: "Reviewing spatial performance and user metrics.",
        content: ["The Largan Villa stands as a harmonious blend of modern aesthetics and climatic responsiveness. The design successfully realized the client's vision for a high-altitude sanctuary, providing cozy interior living spaces alongside panoramic outdoor viewing zones that fully engage with the surrounding forest landscape."]
      }
    }
  },
  {
    ...
    category: "Architecture",
    thumbnail: "/src/assets/images/WhatsApp Image 2026-06-07 at 23.19.21 (8).jpeg",
    summary: "A comprehensive interior overhaul of a 70-square-meter apartment in Tehran, transforming a dated, dark layout into a luminous, modern, open-plan living space.",
    role: "Lead Architectural Designer",
    timeline: "2018",
    location: "Tehran, Iran",
    tools: ["Rhino","AutoCAD","Revit"],
  ...
  },
  {
    ...
    category: "Architecture",
    thumbnail: "/src/assets/images/WhatsApp Image 2026-06-07 at 23.19.21 (9).jpeg",
    summary: "The City Porch is a mixed-use residential, cultural, and entertainment complex in Tehran designed to harmoniously integrate modular, terraced structures into a challenging steep hillside.",
    role: "Lead Architectural Designer",
    timeline: "2016",
    location: "Tehran, Iran",
    tools: ["Rhino","AutoCAD","Revit"],
  ...
  },
  {
    ...
    category: "Experience Design",
    thumbnail: "/src/assets/images/CANVA_proof_II-AY0PDHUL1nux-1.png",
    summary: "Rolling Nest is an integrated brand system and nomadic habitat concept combining a high-performance double-curved mobile shell on wheels with custom-tailored mobile applications and cohesive visual identity guidelines.",
    ...
    caseStudy: {
      challenge: {
        ...
        image: "/src/assets/images/CANVA_proof_II-AY0PDHUL1nux-1.png",
        imageCaption: "Rolling Nest brand identity proof, establishing a minimalist typography pairing and warm-hued visual guidelines."
      },
      researchAnalysis: {
    ...
    gallery: [
      "/src/assets/images/CANVA_proof_II-AY0PDHUL1nux-1.png",
      "/src/assets/images/CANVA_proof_II-AY0PDHUL1nux-2.png",
      "/src/assets/images/Screenshot 2024-01-15 222040.png",
      "/src/assets/images/Screenshot 2024-01-15 222109.png",
      "/src/assets/images/Screenshot 2024-01-15 222648.png",
      "/src/assets/images/Screenshot 2024-01-15 222758.png",
      "/src/assets/images/Screenshot 2024-01-15 235009.png",
      "/src/assets/images/Screenshot 2024-01-16 000510.png",
      "/src/assets/images/2 2222.png",
      "/src/assets/images/trifold-1.png"
    ]
  },
  {
    id: "verde-vista",
    ...
    category: "Experience Design",
    thumbnail: "/src/assets/images/verdevista logo.png",
    summary: "Verde Vista is an eco-centric lifestyle brand that blends modern earthen textures with organic retail packaging, custom typography, and dynamic visual touchpoints to construct a holistic sustainable identity.",
    role: "Lead Brand Strategist & Visual Designer",
    timeline: "2024",
    location: "Tehran / London",
    tools: ["Figma", "Adobe Suite", "Illustrator", "Photoshop"],
    tags: ["Brand Identity", "Sustainable Design", "Earthen Aesthetics", "Packaging Packaging Systems", "Visual Curation"],
    caseStudy: {
      challenge: {
        title: "The Sustainable Brand Integration",
        subtitle: "Creating a tactile organic identity that communicates purity and ecological consciousness for modern lifestyles.",
        content: [
        ...
        image: "/src/assets/images/verdevista logo.png",
        imageCaption: "Verde Vista signature visual identity and brand seal, centering natural symmetries and balanced typography."
      },
      researchAnalysis: {
    ...
    gallery: [
      "/src/assets/images/verdevista logo.png",
      "/src/assets/images/pocket.png",
      "/src/assets/images/insta-logo.png",
      "/src/assets/images/shirt-cart.png",
      "/src/assets/images/coffee.png",
      "/src/assets/images/food,tshirt.png",
      "/src/assets/images/shop-bag.png"
    ]
  },
  {
    id: "farm-tower",
    title: "FARM TOWER",
    subtitle: "A proposal designed for Tehran municipality to represent the city's capability of providing agricultural spaces",
    category: "Architecture",
    thumbnail: "/src/assets/images/WhatsApp Image 2026-06-07 at 23.19.21 (10).jpeg",
    summary: "An innovative vertical farming proposal for Tehran that uses biomimetic leaf-arrangement concepts to maximize natural light penetration for crops.",
    role: "Lead Architectural Designer",
    timeline: "2020 - 2021",
    location: "Tehran, Iran",
    tools: ["Rhino","AutoCAD","Revit"],
    ...
    caseStudy: {
      challenge: {
        title: "The Spatial Challenge",
        subtitle: "Analyzing programmatic requirements and contextual constraints.",
        content: ["Rapid urbanization in metropolitan areas like Tehran significantly limits the land available for traditional agriculture, increasing reliance on external supply chains and widening the gap between citizens and sustainable food production. The challenge was to design a high-density vertical agricultural facility that ensures sufficient and uniform natural sunlight reaches all cultivating surfaces while successfully housing public services, water purification systems, and commercial spaces."],
        image: "/src/assets/images/WhatsApp Image 2026-06-07 at 23.19.21 (10).jpeg",
        imageCaption: "FARM TOWER contextual visualization."
      },
      researchAnalysis: {
        title: "Research & Mapping Process",
        subtitle: "Establishing structural, environmental, and physical methodologies.",
        content: ["The design team turned to biomimicry, analyzing botanical phyllotaxis—the arrangement of leaves on a plant stem. Research into alternate spiral and alternate distichous patterns revealed how plants optimize leaf angles (such as 144-degree and 120-degree rotations) to minimize self-shading and maximize solar absorption. Translating these botanical ratios into architectural massing provided a mathematical framework for floor plate distribution and solar access optimization."]
      },
      designSolution: {
        title: "Materiality & Structural Expression",
        subtitle: "Synthesizing research vectors into precise architectural form.",
  ...
  },
  {
    ...
    category: "Architecture",
    thumbnail: "/src/assets/images/WhatsApp Image 2026-06-07 at 23.19.21 (4).jpeg",
    summary: "An innovative retail interior design in Tehran featuring rammed-earth partitions, gravel flooring, and organic wooden fixtures to showcase organic foods and lifestyle goods.",
    role: "Lead Interior Architect",
    timeline: "2020 - 2021",
    location: "Tehran, Iran",
    tools: ["Rhino","AutoCAD","Revit"],
